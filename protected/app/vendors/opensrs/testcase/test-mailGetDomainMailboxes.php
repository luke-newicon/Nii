...
<form action="test-mailGetDomainMailboxes.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailGetDomainMailboxes">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			...
			<td width="100%"><span class="headLine">Limit </span> <input type="text" name="limit" value="" class="frontBox"></td>
                ...
                <tr>
			<td><input value="Get List" type="submit"></td>
		</tr>
	</table>
</form>
