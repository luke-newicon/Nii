...
<form action="test-lookupBelongsToRsp.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="lookupBelongsToRsp">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td><input value="Domain Belongs to RSP" type="submit"></td>
		</tr>
	</table>
</form>
