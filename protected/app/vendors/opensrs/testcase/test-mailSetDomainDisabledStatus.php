...
<form action="test-mailSetDomainDisabledStatus.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailSetDomainDisabledStatus">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">disabled </span> <input type="text" name="disabled" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Set Domain Disabled Status" type="submit"></td>
		</tr>
	</table>
</form>
