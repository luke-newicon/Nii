...
<form action="test-lookupGetDomainsContacts.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="lookupGetDomainsContacts">

	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td width="100%"><span class="headLine">domain_list </span> <input type="text" name="domain_list" value="" class="frontBox"> <small>coma separated, no spaces</small></td>
		</tr>
		<tr>
			<td><input value="Get Domains Contacts" type="submit"></td>
		</tr>
	</table>
</form>
