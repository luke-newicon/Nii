...
<form action="test-lookupGetDomain.php" method="post">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">max_to_expiry </span> <input type="text" name="max_to_expiry" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td width="100%"><span class="headLine">min_to_expiry </span> <input type="text" name="min_to_expiry" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Get Domain" type="submit"></td>
		</tr>
	</table>
</form>
