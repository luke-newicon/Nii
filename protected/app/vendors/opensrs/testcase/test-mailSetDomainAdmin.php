...
<form action="test-mailSetDomainAdmin.php" method="post">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">state </span> <input type="text" name="state" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Set Domain Admin" type="submit"></td>
		</tr>
	</table>
</form>
