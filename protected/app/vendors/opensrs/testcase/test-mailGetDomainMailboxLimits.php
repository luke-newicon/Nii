...
<form action="test-mailGetDomainMailboxLimits.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailGetDomainMailboxLimits">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td><input value="Get Domain Mailbox Limits" type="submit"></td>
		</tr>
	</table>
</form>
