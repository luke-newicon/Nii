...
if (isSet($_POST['function'])) {
	...
	$callArray = array (
		...
		"data" => array (
			...
			"add_to_all_registry" => $_POST["add_to_all_registry"]
		)
	);
...
<form action="test-nsCreate.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="nsCreate">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">add_to_all_registry </span> <input type="text" name="add_to_all_registry" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Create nameserver" type="submit"></td>
		</tr>
	</table>
</form>
