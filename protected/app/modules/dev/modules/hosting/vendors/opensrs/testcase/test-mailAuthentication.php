...
<form action="test-mailAuthentication.php" method="post">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">domain </span> <input type="text" name="authdomain" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Verify mail user" type="submit"></td>
		</tr>
	</table>
</form>
