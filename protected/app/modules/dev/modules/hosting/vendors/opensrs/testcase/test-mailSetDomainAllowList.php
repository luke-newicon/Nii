...
<form action="test-mailSetDomainAllowList.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailSetDomainAllowList">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <input value="Set Domain Allow List" type="submit" />
</form>
