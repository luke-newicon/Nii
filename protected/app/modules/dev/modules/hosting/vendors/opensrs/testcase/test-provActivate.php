...
<form action="test-provActivate.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="provActivate">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">domainname </span> <input type="text" name="domainname" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Activate Domain" type="submit"></td>
		</tr>
	</table>
</form>
