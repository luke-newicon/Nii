...
if (isSet($_POST['function'])) {
	...
	$callArray = array (
		...
		"data" => array (
			...
			"add_ns" => $_POST["add_ns"],
			"assign_ns" => $_POST["assign_ns"],
			"remove_ns" => $_POST["remove_ns"]
		)
	);
...
<form action="test-nsAdvancedUpdt.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="nsAdvancedUpdt">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">add_ns </span> <input type="text" name="add_ns" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td width="100%"><span class="headLine">assign_ns </span> <input type="text" name="assign_ns" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td width="100%"><span class="headLine">remove_ns </span> <input type="text" name="remove_ns" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Advanced Update" type="submit"></td>
		</tr>
	</table>
</form>
