...
<form action="test-mailSetDomainBlockList.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailSetDomainBlockList">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">list </span> <input type="text" name="list" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Set Domain Block List" type="submit"></td>
		</tr>
	</table>
</form>
