...
<form action="test-provQueryQueuedRequest.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="provQueryQueuedRequest">

	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td width="100%"><span class="headLine">request_id </span> <input type="text" name="request_id" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Query Queued Request" type="submit"></td>
		</tr>
	</table>
</form>
