...
<form action="test-mailGetNumDomainMailboxes.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailGetNumDomainMailboxes">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td><input value="Get Num Domain Mailboxes" type="submit"></td>
		</tr>
	</table>
</form>
