...
<form action="test-provRevoke.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="provRevoke">

	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td width="100%"><span class="headLine">reseller </span> <input type="text" name="reseller" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td width="100%"><span class="headLine">domain </span> <input type="text" name="domain" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td width="100%"><span class="headLine">notes </span> <input type="text" name="notes" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Revoke" type="submit"></td>
		</tr>
	</table>
</form>
