...
<form action="test-mailChangeDomain.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailChangeDomain">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">filtermx </span> <input type="text" name="filtermx" value="" class="frontBox"></td>
		</tr>
		<tr>
		...
		<tr>
			<td><input value="Change Domain" type="submit"></td>
		</tr>
	</table>
</form>
