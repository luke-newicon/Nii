...
<form action="test-provSendCIRAapproval.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="provSendCIRAapproval">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td><input value="Send CIRA Approval" type="submit"></td>
		</tr>
	</table>
</form>
