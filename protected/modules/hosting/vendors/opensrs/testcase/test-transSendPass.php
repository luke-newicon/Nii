...
<form action="test-transSendPass.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="transSendPass">

	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td width="100%"><span class="headLine">domain_name </span> <input type="text" name="domain_name" value="" class="frontBox"></td>
		</tr>
		<tr>
