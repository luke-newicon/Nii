...
if (isSet($_POST['function'])) {
	...
	$callArray = array (
		...
		"data" => array (
			...
			"get_request_address" => $_POST["get_request_address"]
		)
	);
...
<form action="test-transCheck.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="transCheck">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">check_status </span> <input type="text" name="check_status" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td width="100%"><span class="headLine">get_request_address </span> <input type="text" name="get_request_address" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Check Transfer" type="submit"></td>
		</tr>
	</table>
</form>
