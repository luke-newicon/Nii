...
<form action="test-subuserModify.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="subuserModify">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">sub_id </span> <input type="text" name="sub_id" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Modify subuser" type="submit"></td>
		</tr>
	</table>
</form>
