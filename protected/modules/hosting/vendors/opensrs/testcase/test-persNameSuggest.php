...
<form action="test-persNameSuggest.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="persNameSuggest">

	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td width="100%"><span class="headLine">searchstring </span> <input type="text" name="searchstring" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Personal Name Suggestions" type="submit"></td>
		</tr>
	</table>
</form>
