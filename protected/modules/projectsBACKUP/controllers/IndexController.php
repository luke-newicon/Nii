...
class IndexController extends NController
{
	...
	public function actionView($id)
	{
		...
		if(isset($_GET['ProjectsProject']))
			$modelProjectsIssue->attributes=$_GET['ProjectsProject'];

		$this->render('view',array(
			'model'=>$this->loadModel($id),
			'modelProjectsIssue'=>$modelProjectsIssue
		));
	}
	...
	{
		$model=new ProjectsProject;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['ProjectsProject']))
		{
			$model->attributes=$_POST['ProjectsProject'];
...
//		));
	...
	public function loadModel($id){
		$model=ProjectsProject::model()->findByPk((int)$id);
		if($model===null)
	...
	protected function performAjaxValidation($model){
		if(isset($_POST['ajax']) && $_POST['ajax']==='projects-project-form')
		{
