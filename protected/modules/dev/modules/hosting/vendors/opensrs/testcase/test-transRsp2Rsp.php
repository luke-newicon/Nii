...
<form action="test-transRsp2Rsp.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="transRsp2Rsp">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">grsp </span> <input type="text" name="grsp" value="" class="frontBox"></td>
		</tr>
		<tr>
		...
		<tr>
			<td><input value="rsp2rsp Push Transfer" type="submit"></td>
		</tr>
	</table>
</form>
