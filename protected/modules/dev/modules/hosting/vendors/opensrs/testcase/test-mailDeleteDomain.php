...
<form action="test-mailDeleteDomain.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="mailDeleteDomain">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">cascade </span> <input type="text" name="cascade" value="" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Delete Domain" type="submit"></td>
		</tr>
	</table>
</form>
