...
Class NSprite extends CApplicationComponent
{
	...
	/**
	 * array of relative image paths to include in the sprite
	 * would be cool in version 2 if this just reads all images in another folder
	 * and uses that to generate the sprite.
	 * @property array 
	 */
	public $sprites = array(
		'fam/add.png',
		'fam/book_open.png',
		'fugue/application-sidebar.png'
	...
	/**
	 * generate a nice html page to see the icons and their class names
	 */
	public function _generateHtmlPage(){
		// TODO
	}
